...
class FAQController extends Controller
{
   ...
   public function store(AddFAQRequest $request) {
      ...
      return response()->json(['message' => ' FAQ Mới được thêm thành công!'], 200);
   }
   ...
   public function update(UpdateFAQRequest $request, Faq $faq) {
      ...
      return response()->json(['message' => 'FAQ cập nhật thành công!'], 200);
   }

   public function destroy(Faq $faq) {
      $this->faqService->deleteFAQ($faq);
      return response()->json(['message' => 'FAQ Đã xoá thành công!'], 200);
   }
