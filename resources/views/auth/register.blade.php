      ...
      <div class="border p-4 rounded col-sm-10 col-md-10 col-lg-10 col-xl-8">
         ...
         <form action="{{ route('register.create') }}" method="POST" id="registerForm">
            ...
            <div class="form-check">
               ...
               <label class="form-check-label" for="terms_and_conditions">Tôi đồng ý với các Điều khoản</label>
               <div class="terms_and_conditions-feedback"></div>
             </div>
            <button type="submit" class="btn btn-dark col-12 mt-5" id="registerBtn">Đăng ký</button>
         </form>
