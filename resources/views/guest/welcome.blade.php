...
@section('content')
   <div class="container">
      ...
      <div class="row d-flex align-items-center justify-content-center flex-md-row">
         <div class="text-center col-md-9" style="margin: 9rem 0 7rem 0;" data-aos="fade-in" data-aos-duration="1500">
            <h1 class="title-lg fw-bold"><span class="text-underline-wavy">Giải phóng</span> sự tò mò của bạn: Chào mừng bạn đến với <span class="text-highlight">Librariant</span>! 📚</h1>
            <h5 class="fw-normal fs-header text-secondary lh-sm my-4" style="padding: 0px 100px;">Hợp lý hóa hoạt động thư viện với nền tảng thân thiện với người dùng của chúng tôi để lập danh mục, cho mượn và trả sách. Tìm sách dễ dàng, giữ chỗ và nhận thông báo. Khám phá nền tảng của chúng tôi để có một môi trường thư viện có tổ chức và dễ tiếp cận!</h5>
            <a class="btn btn-dark btn-lg exploreBtn mx-2" href="{{ route('guest.books') }}" role="button">Khám phá ngay bây giờ</a>
            <a class="btn btn-dark btn-lg learnMoreBtn mx-2" href="{{ route('visitor.about_us') }}" role="button">Tìm hiểu thêm</a>
         </div>
      </div>
   </div>
   <div class="m-6">
      <h2 class="text-center pt-5 pb-4" data-aos="fade-down" data-aos-duration="1000">✨ Tính năng & Dịch vụ của chúng tôi</h2>
      <div class="row px-4">
         <div class="col-md-4 text-center my-2" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">
            <div class="d-flex flex-column align-items-center h-100 bg-body-secondary rounded p-3">
               ...
               <h4>Bộ sưu tập mở rộng</h4>
               <p>Thư viện của chúng tôi tự hào có một bộ sưu tập sách, bài báo và tài nguyên phong phú và đa dạng, phục vụ nhiều sở thích và lĩnh vực khác nhau.</p>
            </div>
        </div>
   ...
   <div class="m-6">
      <div class="row align-items-center mx-4 p-3 rounded">
         ...
         <div class="col-md-12 col-lg-12 col-xl-7 my-2" data-aos="fade-left" data-aos-duration="1000">
            <h2 class="fw-semibold">📝 Làm thế nào nó hoạt động?</h2>
   ...
   <div class="m-6">
      <div class="d-flex align-items-baseline justify-content-between mb-3 px-4">
         <h2 class="fw-medium" data-aos="fade-in" data-aos-duration="1000">Sách phổ biến</h2>
