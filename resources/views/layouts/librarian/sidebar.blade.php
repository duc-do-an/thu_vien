   ...
   <div class="offcanvas-body p-3" style="height: 100vh;">
      <div class="position-fixed px-3">
         ...
         <div class="nav nav-pills flex-column mb-auto">
            ...
            <a href="{{ route('librarian.getEmailList') }}" class="nav-link text-white mb-1 {{ Route::currentRouteNamed('librarian.getEmailList') ? 'active' : '' }}">
               <i class="fa fa-envelope me-3"></i>Contacts
            </a>
            <a href="{{ route('librarian.comments') }}" class="nav-link text-white mb-1 {{ Route::currentRouteNamed('librarian.comments') ? 'active' : '' }}">
               <i class="bi bi-star me-3"></i>Commemts
            </a>
            <a href="{{ route('librarian.reviews') }}" class="nav-link text-white mb-1 {{ Route::currentRouteNamed('librarian.reviews') ? 'active' : '' }}">
               <i class="bi bi-heart me-3"></i>Reviews
            </a>
         </div>
      </div>
   </div>
