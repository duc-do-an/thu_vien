...
@endsection
@section('content')
<form action="{{route('librarian.postEmailEdit',['id'=> $emails->id ])}}" method="post" class="container" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                ...
                <div class="mb-3 me-2  bp-5">
                  <div class="mb-3">
                    ...
                    <input name="name" type="text" class="form-control" id="formGroupExampleInput2" value="{{$emails->name}}" disabled="" >
                        ...
                        <button type="submit" class=""><i class="" aria-hidden="true"></i>Xác Nhận</button>
                        <a href="{{route('librarian.getEmailList')}}" class="">Quay lại</a>
