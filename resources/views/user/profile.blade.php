...
@section('content')
            ...
            <div class="col-xl-10">
               <div class="d-flex flex-wrap">
                  <div class="col-lg-4 col-md-6 col-12 mb-3">
                     <label for="full_name" class="col-form-label fw-semibold">📛Họ và tên:</label>
                  ...
                  <div class="col-lg-4 col-md-6 col-12 ps-md-3 ps-xl-3 mb-3">
                     <label for="username" class="col-form-label fw-semibold">🔍 Tên tài khoản:</label>
                  ...
                  <div class="col-lg-4 col-md-6 col-12 ps-md-3 ps-lg-0 ps-xl-0 mb-3">
                     <label for="phone_number" class="col-form-label fw-semibold">📞 Điện thoại:</label>
                     <input type="text" class="form-control" value="{{ Auth::user()->phone_number }}" disabled>
                  </div>
                  <div class="col-lg-4 col-md-6 col-12 ps-lg-3 ps-xl-3 mb-3">
                     <label for="dob" class="col-form-label fw-semibold">🎂 Ngày Sinh:</label>
                     <input type="text" class="form-control" value="{{ date('F d, Y', strtotime(Auth::user()->date_of_birth)) }}" disabled>
                  </div>
                  <div class="col-lg-4 col-md-6 col-12 ps-md-3 ps-xl-3 mb-3">
                     <label for="dob" class="col-form-label fw-semibold">📆 Đã tham gia kể từ:</label>
   ...
   @if ($borrowHistories->isEmpty())
      <div class="d-flex justify-content-center align-items-center m-6" style="height: 54.2vh">
         <h2 class="text-secondary pt-1">📚 Bạn chưa mượn cuốn sách nào.</h2>
      </div>
   @else
      <div class="mx-6 pt-5">
         <h2 class="text-center pb-3">⌛ Lịch sử mượn</h2>
