...
use App\Http\Controllers\librarian\ReviewController;
use App\Http\Controllers\librarian\CommentController;
...
route::get('/auth/forgot-password',[MailController::class,'getinputEmail'])->name('getinputEmail');
route::post('/auth/forgot-password',[MailController::class,'postinputEmail'])->name('postinputEmail');
//
Route::middleware(['visitor'])->group(function() {
   ...
   Route::get('/contact', [ContactController::class, 'getcontact'])->name('visitor.contact');
   Route::post('/contact', [ContactController::class, 'postcontact'])->name('visitor.postcontact');
});
Route::group(['prefix' => 'email'], function () {
        Route::get('/danhsach', [ContactController::class, 'index'])->name('librarian.getEmailList');
        Route::get('sua/{id}',[ContactController::class,'getEmailEdit'])->name('librarian.getEmailEdit');
        Route::put('sua/{id}',[ContactController::class,'postEmailEdit'])->name('librarian.postEmailEdit');
        Route::delete('xoa/{id}',[ContactController::class,'getEmailDelete'])->name('librarian.getEmailDelete');
    });
...
Route::middleware(['guest'])->group(function() {
   ...
   Route::post('/forgot-password', [LoginController::class, 'sendEmail'])->name('password.email');
...
Route::get('/visitor/contact', [MailController::class, 'getlienhe'])->name('getlienhe');

Route::post('/visitor/contact', [MailController::class, 'postlienhe'])->name('postlienhe');
